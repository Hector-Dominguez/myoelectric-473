...
void InitializeSensor(MyoSensor * thisSensor, int channelNumber)
{
  ...
  String toPrint = "";
  String catString = "";
  toPrint = "Calculating yRest for channel " + channelNumber;
  Serial.println();
  ...
  toPrint = "Calculating yComfortable for channel " + channelNumber;
  Serial.println(toPrint);
  ...
  toPrint = "yComfortable(" + channelNumber;
  catString = + ") = " + yComfortable;
  toPrint = toPrint + catString;
  Serial.println(toPrint);
