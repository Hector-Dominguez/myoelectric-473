...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DIGITAL_IO" URI="http://resources/4.0.16/app/DIGITAL_IO/1" description="The DIGITAL_IO APP is used to configure &#xA; a port pin as digital Input/Output." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="OutputPin1" appLabel="">
  ...
  <hwResources name="pin" URI="http://resources/4.0.16/app/DIGITAL_IO/1/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/61" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
